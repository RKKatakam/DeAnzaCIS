...
public abstract class Currency {
	...
	// return the actual money value of the Krone object as a combination of the whole value and fractional value attributes. 
	public double actualValue() {
		double value = this.wholePart + this.fractionalPart/100.00;
		return value;
	}
